...
export const metadata: Metadata = {
	...
	keywords: [
		...
		"psychiatric therapy Tooele",
		"mental health practitioner Utah",
		"psychiatric services Utah",
		"mental health treatment Utah",
		"psychiatric care Utah",
		"mental health services Utah",
		"psychiatric evaluation Utah",
		"mental health assessment Tooele",
		"psychiatric diagnosis Tooele",
		"mental health evaluation Tooele",
		"psychiatric consultation Utah",
		"mental health therapy Tooele",
